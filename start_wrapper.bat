...
echo Wrapper: Offline Remake
echo A project from VisualPlugin adapted by Jon
...
if /i "!choice!"=="jon" echo watch jon on youtube & goto wrapperidle
...
if /i "!choice!"=="watch jon on youtube" goto w_a_t_c_h
